...
public class CopyOnWriteArrayListPractise {
	...
	public static void main(String[] args) {
        ...
        // this is used where the read operations are more as compared to write operations otherwise lot of memory will get consumed and it will be of no use then.
